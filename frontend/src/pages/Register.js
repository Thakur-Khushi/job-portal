      ...
      <div className="max-w-md w-full">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center">
            ...
            ></div>
            <div
              className={`flex-1 h-2 ${step >= 2 ? 'bg-green-500' : 'bg-gray-300'}`}
            ></div>
            <div
        ...
        <div className="bg-white/90 backdrop-blur-lg p-10 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-500">
              ...
              <div className="space-y-5 animate__animated animate__fadeInLeft">
                <div>
                  ...
                  <input
                    ...
                    className={`modern-input ${fieldErrors.name ? 'border-red-500' : ''}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`modern-input ${fieldErrors.email ? 'border-red-500' : ''}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`modern-input ${fieldErrors.password ? 'border-red-500' : ''}`}
